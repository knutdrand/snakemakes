...
command = """macs2 callpeak -t {snakemake.input[0]} %s %s --bdg --broad --outdir {snakemake.wildcards.species}/broadpeakcalling -n {snakemake.wildcards.sample}""" % (control, extra)
print(command)
shell(command)
